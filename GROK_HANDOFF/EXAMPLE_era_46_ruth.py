"""
era_46_ruth.py -- The Book of Ruth (Ruth 1-4)

A Moabite widow clings to her Israelite mother-in-law, gleans in the fields
of Bethlehem, and is redeemed by a kinsman-redeemer (go'el) named Boaz. This
four-chapter narrative is a masterpiece of hesed theology: covenant loyalty
enacted between a foreigner and the covenant people, producing the lineage
that leads to David and ultimately to the Messiah. Ruth demonstrates that
YHWH's redemptive purposes transcend ethnic boundaries -- a Moabite woman
enters the genealogy of Israel's greatest king.
"""
...
CHAPTERS = [
    {
        ...
        "sections": [
            {
                "heading": "Famine, Moab, and Death (1:1-5)",
            ...
            {
                "heading": "Naomi's Urging and Ruth's Oath (1:6-18)",
            ...
            {
                "heading": "Return to Bethlehem: Empty and Bitter (1:19-22)",
...

    {
        ...
        "sections": [
            {
                "heading": "Ruth Goes to Glean (2:1-3)",
            ...
            {
                "heading": "Boaz Notices Ruth (2:4-13)",
            ...
            {
                "heading": "Boaz's Generosity and Naomi's Hope (2:14-23)",
...

    {
        ...
        "sections": [
            ...
            {
                "heading": "Midnight at the Threshing Floor (3:6-13)",
            ...
            {
                "heading": "Dawn Departure and Naomi's Confidence (3:14-18)",
...

    {
        ...
        "sections": [
            {
                "heading": "The Gate Proceedings (4:1-6)",
            ...
            {
                "heading": "The Sandal Transfer and Boaz's Declaration (4:7-12)",
            ...
            {
                "heading": "Birth of Obed and the Davidic Genealogy (4:13-22)",
