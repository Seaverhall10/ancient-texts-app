...
CHAPTERS = [
    {
        ...
        "sections": [
            {
                "heading": "Hebrew Terms You Will See Throughout",
                "body": "The Old Testament was written primarily in <strong>Hebrew</strong> (with portions of Daniel and Ezra in <strong>Aramaic</strong>, a related Semitic language). We transliterate key Hebrew words so you can see the original concepts behind the English translations. Here are the most important ones you will encounter repeatedly:<br><br>"
                        "<strong>Elohim</strong> \u2014 The most common Hebrew word for 'God.' Grammatically, it is a <em>plural</em> noun, but when referring to the God of Israel it takes <em>singular</em> verbs ('Elohim created,' not 'Elohim created-plural'). This plural form does not mean 'gods' in the polytheistic sense; scholars debate whether it is a 'plural of majesty' (like the royal 'we'), a reference to God addressing his heavenly court, or an expression of God's fullness. The same word <em>is</em> used for other divine beings in passages like Psalm 82:1 ('God stands in the divine assembly; he judges among the elohim'), where it clearly refers to members of God's heavenly council. Context determines the meaning.<br><br>"
                        "<strong>YHWH</strong> (pronounced 'Yahweh') \u2014 The personal covenant name of God, revealed to Moses at the burning bush (Exodus 3:14). It derives from the Hebrew verb <em>hayah</em> ('to be') and is often translated 'the LORD' (in small capitals) in English Bibles. Ancient Jews considered this name too sacred to pronounce aloud, substituting <em>Adonai</em> ('my Lord'). When you see 'the LORD' in English translations, the underlying Hebrew is YHWH.<br><br>"
                        "<strong>Tohu vavohu</strong> \u2014 'Formless and void' (Genesis 1:2). This Hebrew phrase describes the pre-creation state of the earth: chaotic, empty, unordered. God's creative work transforms the <em>tohu vavohu</em> into an ordered, inhabited cosmos.<br><br>"
                        "<strong>Ruach</strong> \u2014 A single Hebrew word that means 'spirit,' 'wind,' or 'breath,' depending on context. In Genesis 1:2, the <em>ruach elohim</em> ('Spirit/wind of God') hovers over the waters. The same word describes the breath of life God breathes into Adam (Genesis 2:7) and the wind God sends over the flood waters (Genesis 8:1).<br><br>"
                        "<strong>Nephesh</strong> (also <em>nefesh</em>) \u2014 Often translated 'soul,' but the Hebrew concept is very different from the Greek idea of an immortal soul trapped in a body. <em>Nephesh</em> means the whole living being \u2014 the entire person animated by God's breath. Animals are also called <em>nephesh chayyah</em> ('living creatures'). When the breath departs, the nephesh ceases.<br><br>"
                        "<strong>Tselem</strong> and <strong>Demut</strong> \u2014 'Image' and 'likeness.' Humanity is created <em>betselem elohim</em> ('in the image of God'). In the ancient Near East, a king's image (statue) was placed in conquered territory to represent his authority and presence. Every human being is God's image \u2014 his representative in creation.<br><br>"
                        "<strong>Berit</strong> \u2014 'Covenant.' A binding agreement between two parties, often sealed with a ritual. God's covenants with Noah, Abraham, Israel at Sinai, and David form the backbone of the biblical story. The Hebrew Bible itself is called the 'Old Covenant' (Testament), and Christians believe Jesus inaugurated a 'New Covenant.'<br><br>"
                        "<strong>Hesed</strong> \u2014 One of the most important words in the Hebrew Bible, often translated 'steadfast love,' 'lovingkindness,' or 'covenant loyalty.' It describes God's faithful, enduring commitment to his covenant partners. No single English word captures it \u2014 it combines love, loyalty, mercy, and faithfulness.<br><br>"
                        "<strong>Zera</strong> \u2014 'Seed' or 'offspring.' This word drives the entire narrative from Genesis 3:15 onward. The 'seed of the woman' who will crush the serpent's head is traced through a specific lineage: Seth, Noah, Shem, Abraham, Judah, David, and ultimately to Christ.<br><br>"
                        "<strong>Torah</strong> \u2014 'Law,' 'instruction,' or 'teaching.' Refers to the first five books of the Bible (Genesis through Deuteronomy), also called the Pentateuch (Greek for 'five scrolls'). Torah is not merely legal code but God's comprehensive instruction for life."
            },
            {
                "heading": "What Is the 'Ancient Near East' (ANE)?",
                "body": "Throughout this study, you will see references to the <strong>ANE</strong> \u2014 the <strong>Ancient Near East</strong>. This term refers to the civilizations surrounding ancient Israel: <strong>Mesopotamia</strong> (modern Iraq \u2014 Sumer, Babylon, Assyria), <strong>Egypt</strong>, <strong>Canaan/Ugarit</strong> (modern Syria/Lebanon/Israel), the <strong>Hittite Empire</strong> (modern Turkey), and <strong>Persia</strong> (modern Iran).<br><br>"
                        "Why does this matter? Because the Bible was not written in a vacuum. The authors of Genesis, Exodus, and the rest of the Hebrew Bible lived in this world, spoke its languages, and knew its stories. When Genesis describes creation, the original audience would have immediately recognized how it differed from the Babylonian creation story (<em>Enuma Elish</em>). When God makes a covenant with Abraham, the form follows well-known treaty patterns.<br><br>"
                        "Understanding the ANE context does not diminish the Bible \u2014 it illuminates what the Bible is <em>arguing</em>. Genesis is not just telling a story; it is making a theological case against the worldview of its neighbors: one God (not many), creation by speech (not battle), humans as dignified image-bearers (not slave laborers for the gods)."
            },
            {
                "heading": "What Is the 'Divine Council'?",
                "body": "The <strong>divine council</strong> (also called the 'heavenly assembly' or 'heavenly host') is a concept that runs throughout the Hebrew Bible but is often missed by modern readers. It refers to <strong>God's heavenly court</strong> \u2014 an assembly of spiritual beings (angels, 'sons of God,' 'holy ones') who serve as God's advisors, messengers, and administrators.<br><br>"
                        "This is <em>not</em> polytheism. YHWH is the unchallenged supreme God who presides over the council. The other members are created beings who carry out his will. Think of it like a king and his royal court: the king rules, the courtiers serve. Key biblical passages that describe the divine council include:<br><br>"
                        "\u2022 <strong>1 Kings 22:19-22</strong> \u2014 The prophet Micaiah sees YHWH 'sitting on his throne, and all the host of heaven standing beside him on his right hand and on his left.'<br>"
                        "\u2022 <strong>Job 1:6; 2:1</strong> \u2014 'The sons of God (b'nei ha'elohim) came to present themselves before YHWH, and the satan came also among them.' Note: 'the satan' here is a title meaning 'the accuser/adversary,' functioning as a prosecutor in the heavenly court.<br>"
                        "\u2022 <strong>Psalm 82:1</strong> \u2014 'God stands in the divine assembly; he judges among the elohim (gods/divine beings).'<br>"
                        "\u2022 <strong>Psalm 89:5-7</strong> \u2014 'Who among the sons of God (b'nei elim) is like YHWH?'<br>"
                        "\u2022 <strong>Isaiah 6:1-8</strong> \u2014 Isaiah sees YHWH on his throne with the seraphim, and God says 'Whom shall I send, and who will go for US?'<br><br>"
                        "The scholar <strong>Michael Heiser</strong> (author of <em>The Unseen Realm</em>, 2015) has done groundbreaking work recovering this biblical worldview. When Genesis 1:26 says 'Let US make man in OUR image,' the most contextually supported reading is that God is addressing his divine council \u2014 announcing his plan to the assembled heavenly court. God alone creates (the verb shifts to singular: 'so God created'), but the council witnesses the deliberation.<br><br>"
                        "This concept becomes critically important in Genesis 6 (the 'sons of God' who rebel), in Deuteronomy 32:8-9 (where God allots nations to divine council members), and throughout the prophetic and apocalyptic literature."
            },
            {
                "heading": "What Is the 'Second Temple Period'?",
                "body": "You will frequently see sections labeled <strong>'Second Temple'</strong> in these chapters. This refers to a specific historical period in Jewish history, roughly <strong>516 BC to 70 AD</strong> \u2014 about 586 years.<br><br>"
                        "Here is the background: Solomon built the <strong>First Temple</strong> in Jerusalem around 960 BC. The Babylonians destroyed it in <strong>586 BC</strong> and deported many Jews to Babylon. After the Persians conquered Babylon, the Jewish exiles returned and built a <strong>Second Temple</strong> on the same site, completed around <strong>516 BC</strong>. This Second Temple stood until the Romans destroyed it in <strong>70 AD</strong>.<br><br>"
                        "The <em>Second Temple period</em> was an extraordinarily productive time for Jewish literature and theology. Many important texts were written during this era: the books of Daniel, Esther, Ezra, Nehemiah, and many of the Psalms in their final form, plus a vast body of literature outside the Hebrew Bible \u2014 1 Enoch, Jubilees, the Dead Sea Scrolls, the Wisdom of Solomon, Sirach, the writings of Josephus and Philo, and the Targums. Jesus, the apostles, and the entire New Testament emerge from this period.<br><br>"
                        "When we cite 'Second Temple sources,' we are showing how Jewish readers between 500 BC and 70 AD interpreted the Genesis and Exodus texts. These interpretations are not Scripture, but they illuminate how the original concepts were understood by people much closer in time and culture to the biblical authors."
            },
            {
                "heading": "What Are the 'LXX' (Septuagint), 'MT' (Masoretic Text), and 'DSS' (Dead Sea Scrolls)?",
                "body": "These abbreviations refer to the major <strong>textual traditions</strong> of the Hebrew Bible \u2014 the ancient manuscripts from which our modern translations are made.<br><br>"
                        "<strong>MT \u2014 Masoretic Text</strong>: The standard Hebrew text of the Old Testament, meticulously preserved by Jewish scribes called the <strong>Masoretes</strong> (from <em>masorah</em>, 'tradition') between the 6th and 10th centuries AD. The Masoretes added vowel markings to the consonantal Hebrew text and established the authoritative reading. Most English translations of the Old Testament are based primarily on the MT.<br><br>"
                        "<strong>LXX \u2014 Septuagint</strong>: A Greek translation of the Hebrew Bible made in Alexandria, Egypt, beginning around <strong>250 BC</strong>. The name 'Septuagint' (Latin for 'seventy') comes from the legend that seventy (or seventy-two) Jewish scholars independently produced identical translations. The LXX is important for three reasons: (1) it preserves readings that are sometimes older than the MT; (2) it was the Bible used by the early church and quoted extensively in the New Testament; and (3) it occasionally differs from the MT in theologically significant ways (e.g., Deuteronomy 32:8, where the LXX reads 'angels of God' and the MT reads 'sons of Israel').<br><br>"
                        "<strong>DSS \u2014 Dead Sea Scrolls</strong>: A collection of approximately <strong>900 manuscripts</strong> discovered between 1947 and 1956 in caves near Qumran, on the northwest shore of the Dead Sea in Israel. Dating from the 3rd century BC to the 1st century AD, they include the oldest surviving copies of nearly every book of the Hebrew Bible, plus many non-biblical texts (1 Enoch, Jubilees, the Community Rule, the War Scroll, and hundreds of other documents). The DSS are crucial because they predate the Masoretic Text by over a thousand years and sometimes preserve readings that agree with the LXX against the MT. The Qumran community that produced many of these scrolls was a Jewish sect (likely Essenes) who withdrew to the desert to study Torah and await the Messiah."
            },
            {
                "heading": "What Are 'Targums'?",
                "body": "A <strong>Targum</strong> (plural: <strong>Targumim</strong>) is an Aramaic translation and interpretive paraphrase of the Hebrew Bible. After the Babylonian exile (6th century BC), many Jews spoke <strong>Aramaic</strong> rather than Hebrew as their daily language. In synagogue services, the Hebrew text would be read aloud and then immediately translated into Aramaic by a speaker called a <em>meturgeman</em> ('translator'). Over time, these oral translations were written down and became the Targums.<br><br>"
                        "The most important Targums are:<br>"
                        "\u2022 <strong>Targum Onkelos</strong> \u2014 A relatively literal Aramaic translation of the Torah (Pentateuch), probably from the 2nd century AD.<br>"
                        "\u2022 <strong>Targum Pseudo-Jonathan</strong> \u2014 A much freer, more expansive paraphrase of the Torah, containing extensive legendary material, theological commentary, and interpretive additions. When we cite Targum Pseudo-Jonathan, we are accessing early Jewish <em>interpretation</em>, not just translation.<br>"
                        "\u2022 <strong>Targum Neofiti</strong> \u2014 A Palestinian Targum of the entire Pentateuch.<br><br>"
                        "Targums matter because they show us how ancient Jews <em>understood</em> the biblical text. When a Targum expands on a verse, it reveals interpretive traditions that may be centuries old."
            },
            {
                "heading": "Theological Terms You Will Encounter",
                "body": "<strong>Theophany</strong> \u2014 A visible, physical appearance of God to human beings. Key examples: God walking in the garden (Genesis 3:8), the burning bush (Exodus 3), the pillar of cloud and fire (Exodus 13), the Sinai theophany (Exodus 19), and the Commander of YHWH's army (Joshua 5:13-15). The Hebrew Bible insists that 'no one can see God and live' (Exodus 33:20), yet repeatedly describes people encountering God in visible form. This tension is resolved by understanding that God reveals himself in limited, accommodated ways.<br><br>"
                        "<strong>Christophany</strong> \u2014 A pre-incarnation appearance of Christ in the Old Testament. Many Christian interpreters identify certain theophanies as appearances of the pre-incarnate Son of God \u2014 particularly the 'Angel of the LORD' (Hebrew: <em>malakh YHWH</em>), who speaks as God, is identified as God, yet is distinct from God. Appearances include Genesis 16 (to Hagar), Genesis 22 (at the binding of Isaac), Exodus 3 (the burning bush), and Joshua 5:13-15 (the Commander of YHWH's army).<br><br>"
                        "<strong>Protoevangelium</strong> \u2014 Latin for 'first gospel.' This term refers specifically to <strong>Genesis 3:15</strong>, where God declares that the 'seed of the woman' will crush the serpent's head. The early church fathers (Irenaeus, Justin Martyr) recognized this as the first prophecy of Christ's victory over Satan, and the term has been used ever since.<br><br>"
                        "<strong>Typology</strong> (Type and Antitype) \u2014 A method of reading the Bible in which an earlier person, event, or institution foreshadows and anticipates a later, greater fulfillment. The earlier element is the <strong>type</strong>; the later fulfillment is the <strong>antitype</strong>. For example: Adam is a <em>type</em> of Christ (Romans 5:14 calls Adam 'a type of the one who was to come'). The Passover lamb is a <em>type</em> of Christ's sacrifice. The flood is a <em>type</em> of baptism (1 Peter 3:21). Typology is not allegory (finding hidden spiritual meanings); it is the recognition that God works in consistent patterns across history, so that earlier events genuinely foreshadow later ones.<br><br>"
                        "<strong>Suzerain-Vassal Treaty</strong> \u2014 A common ANE treaty form in which a powerful king (the <em>suzerain</em>) makes a covenant with a lesser king or people (the <em>vassal</em>). These treaties followed a consistent structure: (1) preamble identifying the suzerain, (2) historical prologue recounting what the suzerain has done for the vassal, (3) stipulations (what the vassal must do), (4) provision for deposit and public reading, (5) list of divine witnesses, and (6) blessings for obedience and curses for disobedience. The Sinai covenant (Exodus 19-24) and the book of Deuteronomy closely follow this pattern, with YHWH as the great suzerain and Israel as his vassal. This is not a treaty between equals but a sovereign act of grace: YHWH chose Israel, delivered them from Egypt, and now establishes the terms of the relationship.<br><br>"
                        "<strong>Covenant Theology</strong> \u2014 The theological framework that understands God's relationship with humanity as structured through a series of covenants: with Adam (creation mandate), Noah (preservation of creation), Abraham (land, seed, blessing), Israel at Sinai (Torah and nationhood), David (eternal kingship), and the New Covenant (Jeremiah 31:31-34, fulfilled in Christ). Each covenant builds on the previous ones. The entire Bible can be read as the unfolding of God's covenant purposes."
            },
            {
                "heading": "Books Referenced Outside the Bible",
                "body": "Throughout these chapters, you will encounter references to texts that are not in the Protestant biblical canon but were widely read and influential in the ancient world:<br><br>"
                        "<strong>1 Enoch</strong> (also called <em>Ethiopic Enoch</em>) \u2014 A collection of Jewish apocalyptic writings attributed to Enoch (Genesis 5:24), composed between the 3rd century BC and 1st century AD. It includes the 'Book of the Watchers' (chapters 1-36), which expands on Genesis 6:1-4. The New Testament book of Jude (vv. 14-15) directly quotes 1 Enoch. It is canonical in the Ethiopian Orthodox Church but not in Catholic or Protestant Bibles. Eleven Aramaic copies were found among the Dead Sea Scrolls.<br><br>"
                        "<strong>Jubilees</strong> (also called <em>Little Genesis</em>) \u2014 A retelling of Genesis through Exodus 12, organized into 49 'jubilee' periods of 49 years each. Written around 160-150 BC. It was authoritative at Qumran (multiple copies found among the DSS) and is canonical in the Ethiopian Orthodox Church.<br><br>"
                        "<strong>Josephus</strong> \u2014 <strong>Flavius Josephus</strong> (37-100 AD) was a Jewish historian who wrote in Greek for Roman audiences. His two major works are <em>Jewish Antiquities</em> (a retelling of the biblical narrative with additional traditions) and <em>The Jewish War</em> (about the Roman-Jewish conflict of 66-73 AD). He provides invaluable historical context and preserves many Second Temple traditions.<br><br>"
                        "<strong>Philo of Alexandria</strong> (20 BC - 50 AD) \u2014 A Jewish philosopher in Alexandria, Egypt, who combined Jewish theology with Greek philosophy. His allegorical interpretations of the Pentateuch were influential on early Christian theology.<br><br>"
                        "<strong>Enuma Elish</strong> \u2014 The Babylonian creation epic (composed around 1100 BC), describing how the god Marduk defeated the chaos dragon Tiamat and created the world from her body. This is the primary ANE text that Genesis 1 responds to and subverts.<br><br>"
                        "<strong>Atrahasis Epic</strong> \u2014 A Babylonian narrative (c. 1700 BC) covering creation, early human history, and a great flood. The fullest ANE parallel to the story arc of Genesis 1-9."
            }
        ]
    },

    {
        ...
        "divine_council_note": "Genesis 1:26 \u2014 'Let US make man in OUR image' \u2014 is the most debated plural in the Bible. Who is God speaking to? Three main options have been proposed: (1) The Trinity \u2014 a Christian reading that sees Father, Son, and Holy Spirit in dialogue; (2) a 'plural of majesty' \u2014 like a king saying 'we decree' (but this grammatical construction is actually unsupported in biblical Hebrew); (3) God addressing his <strong>divine council</strong> \u2014 the heavenly assembly of spiritual beings (angels, 'sons of God') who serve as his royal court (see Psalm 82, Job 38:7, 1 Kings 22:19\u201322 for other glimpses of this assembly). The scholar Michael Heiser argues for option 3: God announces his plan to the assembled council, just as a king might announce a decree to his courtiers. Humans are made in God's image (not the council's), but the council witnesses and participates in the deliberation. This reading is supported by the shift from plural ('let us make') to singular ('so God created') \u2014 God alone does the creating, but the council is the audience.",
