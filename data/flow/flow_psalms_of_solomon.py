"""
Flow translations for Psalms of Solomon -- complete text.
G. Buchanan Gray translation from R.H. Charles, APOT (1913), public domain.
Source: Wesley Center Online (NNU).
...
Chapters: 18 | Verses: 320
"""

FLOW_PSALMS_OF_SOLOMON = {
    1: {  # Psalm 1
    ...
    2: {  # Psalm 2
        ...
        15: 'Because they had defiled themselves with unnatural intercourse. I am pained in my bowels and my inward parts for these things.',
        16: '(And yet) I will justify Thee, O God, in uprightness of heart, For in Thy judgments is Thy righteousness (displayed), O God.',
        ...
        29: 'Delay not, O God, to recompense them on (their) heads, To turn the pride of the dragon into dishonour. 30(26) And I had not long to wait before God showed me the insolent one Slain on the mountains of Egypt, Esteemed of less account than the least on land and sea;',
        30: 'His body, ( too,) borne hither and thither on the billows with much insolence, With none to bury (him), because He had rejected him with dishonour. He reflected not that he was man.',
        31: 'And reflected not on the latter end;',
        32: 'He said: I will be lord of land and sea; And he recognized not that it is God who is great, Mighty in His great strength.',
        33: 'He is king over the heavens, And judgeth kings and kingdoms.',
        34: '(It is He) who setteth me up in glory, And bringeth down the proud to eternal destruction in dishonour, Because they knew Him not.',
        35: 'And now behold, ye princes of the earth, the judgment of the Lord, For a great king and righteous (is He), judging (all) that is under heaven.',
        36: 'Bless God, ye that fear the Lord with wisdom, For the mercy of the Lord will be upon them that fear Him, in the Judgment;',
        37: 'So that He will distinguish between the righteous and the sinner, (And) recompense the sinners for ever according to their deeds;',
        38: 'And have mercy on the righteous, (delivering him) from the affliction of the sinner, And recompensing the sinner for what he hath done to the righteous.',
        39: 'For the Lord is good to them that call upon Him in patience, Doing according to His mercy to His pious ones, Establishing (them) at all times before Him in strength.',
        40: 'Blessed be the Lord for ever before His servants.',
    },
    3: {  # Psalm 3
        ...
        14: 'And he shall not be remembered, when the righteous is visited. This is the portion of sinners for ever.',
        15: 'But they that fear the Lord shall rise to life eternal, And their life (shall be) in the light of the Lord, and shall come to an end no more.',
    },
    4: {  # Psalm 4
    ...
    5: {  # Psalm 5
        ...
        6: 'For man and his portion (lie) before Thee in the balance; He cannot add to, so as to enlarge, what has been prescribed by Thee. O God, 7 (5) when we are in distress we call upon Thee for help, And Thou dost not turn back our petition, for Thou art our God.',
        7: 'Cause not Thy hand to be heavy upon us, Lest through necessity we sin.',
        8: 'Even though Thou restore us not, we will not keep away; But unto Thee will we come.',
        9: 'For if I hunger, unto Thee will I cry, O God; And Thou wilt give to me.',
        10: 'Birds and fish dost Thou nourish, In that Thou givest rain to the steppes that green grass may spring up, (So) to prepare fodder in the steppe for every living thing;',
        11: 'And if they hunger, unto Thee do they lift up their face.',
        12: 'Kings and rulers and peoples Thou dost nourish, O God; And who is the help of the poor and needy, if not Thou, O Lord',
        13: 'And Thou wilt hearken -for who is good and gentle but Thou-- Making glad the soul of the humble by opening Thine hand in mercy.',
        14: 'Man\'s goodness is (bestowed) grudgingly and . . .; And if he repeat (it) without murmuring, even that is marvelous.',
        15: 'But Thy gift is great in goodness and wealth, And he whose hope is (set) on Thee shall have no lack of gifts.',
        16: 'Upon the whole earth is Thy mercy, O Lord, in goodness.',
        17: 'Happy is he whom God remembereth in (granting to him) a due sufficiency;',
        18: 'If a man abound over much, he sinneth.',
        19: 'Sufficient are moderate means with righteousness, And hereby the blessing of the Lord (becomes) abundance with righteousness.',
        20: 'They that fear the Lord rejoice in good (gifts), And Thy goodness is upon Israel in Thy kingdom. Blessed is the glory of the Lord for He is our king.',
    },
    6: {  # Psalm 6
    ...
    8: {  # Psalm 8
        ...
        20: 'As a father (entereth) the house of his sons, (so) he entered (Jerusalem) in peace; He established his feet (there) in great safety.',
        ...
        31: 'Our eyes have seen Thy judgments, O God. We have justified Thy name that is honoured for ever;',
    ...
    9: {  # Psalm 9
        ...
        10: 'For the judgments of the Lord are (given) in righteousness to (every) man and (his) house. Unto whom art Thou good, O God, except to them that call upon the Lord',
        11: 'He cleanseth from sins a soul when it maketh confession, when it maketh acknowledgement;',
        12: 'For shame is upon us and upon our faces on account of all these things.',
        13: 'And to whom doth He forgive sins, except to them that have sinned',
        14: 'Thou blessest the righteous, and dost not reprove them for the sins that they have committed; And Thy goodness is upon them that sin, when they repent.',
        15: 'And, now, Thou art our God, and we the people whom Thou hast loved: Behold and show pity, O God of Israel, for we are Thine; And remove not Thy mercy from us, lest they assail us.',
        16: 'For Thou didst choose the seed of Abraham before all the nations, And didst set Thy name upon us, O Lord,',
        17: 'And Thou wilt not reject (us) for ever. Thou madest a covenant with our fathers concerning us;',
        18: 'And we hope in Thee, when our soul turneth (unto Thee). The mercy of the Lord be upon the house of Israel for ever and ever.',
    },
    10: {  # Psalm 10
    ...
    13: {  # Psalm 13
        ...
        5: 'For terrible is the overthrow of the sinner; But not one of all these things toucheth the righteous. For not alike are the chastening of the righteous (for sins done) in ignorance, And the overthrow of the sinners',
        6: 'Secretly is the righteous chastened, Lest the sinner rejoice over the righteous.',
        7: 'For He correcteth the righteous as a beloved son, And his chastisement is as that of a firstborn.',
        8: '10) For the Lord spareth His pious ones, And blotteth out their errors by His chastening. For the life of the righteous shall be for ever;',
        9: 'But sinners shall be taken away into destruction, And their memorial shall be found no more.',
        10: 'But upon the pious is the mercy of the Lord, And upon them that fear Him His mercy.',
    },
    14: {  # Psalm 14
    ...
    16: {  # Psalm 16
        ...
        2: 'He pricked me, as a horse is pricked, that I might serve Him, My savior and helper at all times saved me.',
        3: 'I will give thanks unto Thee, O God, for Thou hast helped me to (my) salvation; And hast not counted me with sinners to (my) destruction.',
        4: 'Remove not Thy mercy from me, O God, Nor Thy memorial from my heart until I die.',
        5: 'Rule me, O God, (keeping me back) from wicked sin, And from every wicked woman that causeth the simple to stumble.',
        6: 'And let not the beauty of a lawless woman beguile me, Nor any one that is subject to unprofitable sin.',
        7: 'Establish the works of my hands before Thee, And preserve my goings in the remembrance of Thee.',
        8: 'Protect my tongue and my lips with words of truth; Anger and unreasoning wrath put far from me.',
        9: 'Murmuring, and impatience in affliction, remove far from me, When, if I sin, Thou chastenest me that I may return (unto Thee).',
        10: 'But with goodwill and cheerfulness support my soul; When Thou strengthenest my soul, what is given (to me) will be sufficient for me.',
        11: 'For if Thou givest not strength, Who can endure chastisement with poverty',
        12: 'When a man is rebuked by means of his corruption, Thy testing (of him) is in his flesh and in the affliction of poverty.',
        13: 'If the righteous endureth in all these (trials), he shall receive mercy from the Lord.',
    },
    17: {  # Psalm 17
        ...
        5: 'Thou, O Lord, didst choose David (to be) king over Israel, And swaredst to him touching his seed that never should his kingdom fail before Thee.',
        ...
        21: 'For the heavens withheld the rain from dropping upon the earth, Springs were stopped (that sprang) perennial(ly) out of the deeps, (that ran down) from lofty mountains. For there was none among them that wrought righteousness and justice; From the chief of them to the least (of them) all were sinful;',
        ...
        25: 'And that he may purge Jerusalem from nations that trample (her) down to destruction. Wisely, righteously 26 he shall thrust out sinners from (the) inheritance, He shall destroy the pride of the sinner as a potter\'s vessel. With a rod of iron he shall break in pieces all their substance, 21 He shall destroy the godless nations with the word of his mouth; At his rebuke nations shall flee before him, And he shall reprove sinners for the thoughts of their heart.',
        26: 'And he shall gather together a holy people, whom he shall lead in righteousness, And he shall judge the tribes of the people that has been sanctified by the Lord his God.',
        27: 'And he shall not suffer unrighteousness to lodge any more in their midst, Nor shall there dwell with them any man that knoweth wickedness,',
        28: 'For he shall know them, that they are all sons of their God. And he shaIl divide them according to their tribes upon the land,',
        29: 'And neither sojourner nor alien shall sojourn with them any more. He shall judge peoples and nations in the wisdom of his righteousness. Selah.',
        30: 'And he shall have the heathen nations to serve him under his yoke; And he shall glorify the Lord in a place to be seen of all the earth;',
        31: 'And he shall purge Jerusalem, making it holy as of old:',
        32: 'So that nations shall come from the ends of the earth to see his glory, Bringing as gifts her sons who had fainted,',
        33: 'And to see the glory of the Lord, wherewith God hath glorified her. And he (shall be) a righteous king, taught of God, over them,',
        34: 'And there shall be no unrighteousness in his days in their midst, For all shall be holy and their king the anointed of the Lord.',
        35: 'For he shall not put his trust in horse and rider and bow, Nor shall he multiply for himself gold and silver for war, Nor shall he gather confidence from a multitude for the day of battle.',
        36: 'The Lord Himself is his king, the hope of him that is mighty through (his) hope in God. All nations (shall be) in fear before him,',
        37: 'For he will smite the earth with the word of his mouth for ever.',
        38: 'He will bless the people of the Lord with wisdom and gladness,',
        39: 'And he himself (will be) pure from sin, so that he may rule a great people. He will rebuke rulers, and remove sinners by the might of his word;',
        40: 'And (relying) upon his God, throughout his days he will not stumble; For God will make him mighty by means of (His) holy spirit, And wise by means of the spirit of understanding, with strength and righteousness.',
        41: 'And the blessing of the Lord (will be) with him: he will be strong and stumble not;',
        42: 'His hope (will be) in the Lord: who then can prevail against him (He will be) mighty in his works, and strong in the fear of God,',
        43: '(He will be) shepherding the flock of the Lord faithfully and righteously, And will suffer none among them to stumble in their pasture.',
        44: 'He will lead them all aright, And there will be no pride among them that any among them should be oppressed.',
        45: 'This (will be) the majesty of the king of Israel whom God knoweth; He will raise him up over the house of Israel to correct him.',
        46: 'His words (shall be) more refined than costly gold, the choicest; In the assemblies he will judge the peoples, the tribes of the sanctified.',
        47: 'His words (shall be) like the words of the holy ones in the midst of sanctified peoples.',
        48: 'Blessed be they that shall be in those days, In that they shall see the good fortune of Israel which God shall bring to pass in the gathering together of the tribes.',
        49: 'May the Lord hasten His mercy upon Israel! May He deliver us from the uncleanness of unholy enemies! The Lord Himself is our king for ever and ever.',
    },
    18: {  # Psalm 18
