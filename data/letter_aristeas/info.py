...
TEXT_INFO = {
    ...
    "canonical_status": {
        ...
        "detail": "The Letter of Aristeas is not canonical in any Jewish or Christian tradition, "
                  ...
                  "The LXX became the Bible of Diaspora Judaism, the scripture quoted by New "
                  "Testament authors, and the Old Testament of the early church. Josephus "
    ...
    "historical_context": {
        ...
        "historical_connections": "Whether or not the Letter's specific narrative is historically "
                                 ...
                                 "from the Septuagint rather than the Hebrew. Critical passages "
                                 "depend on LXX readings: Isaiah 7:14 uses parthenos (virgin) rather "
                                 "than the Hebrew almah (young woman); the LXX of Deuteronomy 32:8 "
                                 "reads 'sons of God' (angels) rather than the Masoretic 'sons of "
                                 "Israel' — a reading now confirmed by the Dead Sea Scrolls (4QDeutJ). "
                                 "The Letter of Aristeas explains how this epoch-making translation "
                                 "came to exist and why it should be trusted."
    },
