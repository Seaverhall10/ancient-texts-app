"""
era_85b_remnant.py -- Zephaniah 3: The Singing God -- Jerusalem Indicted, Then YHWH Rejoices

The most dramatic reversal in the prophets: from Jerusalem's indictment to the
astonishing image of YHWH himself singing over his restored people. The scattered
nations receive 'pure speech' to worship with one accord -- the reversal of Babel.
The divine warrior who decreed cosmic un-creation now quiets his people with love.
"""
...
CHAPTERS = [
    {
        ...
        "second_temple": [
            ...
            {
                "source": "Acts 2:1-11",
                "summary": "At Pentecost the Spirit enables speech in every tongue -- 'we hear them "
                           "telling in our own tongues the mighty works of God.'",
                "relevance": "The 'pure speech' of Zephaniah 3:9 finds its inaugurated fulfillment at "
                             "Pentecost, where the Babel confusion of languages begins to be reversed as "
                             "all nations hear the gospel in their own tongue."
            }
        ],
        ...
        "cross_refs": [
            ...
            {"ref": "Micah 4:6-7", "note": "'I will assemble the lame and gather those who have been driven away' -- parallel remnant gathering", "type": "ot"},
        ...
        "divine_council_note": "Zephaniah 3:17 presents the divine council sovereign in his most intimate "
                               ...
                               "nations that were confused and allotted to the sons of God (Deut 32:8-9) will "
                               "be given one language to worship YHWH together. This is the Deuteronomy 32 "
                               "allotment reversed: the scattered nations reunited in worship of the Most High. "
                               "The gibbor (mighty one) of 3:17 is the same divine warrior who commanded the "
                               "heavenly hosts in chapter 1's judgment -- now wielding his power to save and "
                               "rejoice rather than destroy.",
        ...
        "sections": [
            {
                ...
                "body": "The city's leaders are predators: officials like lions, judges like wolves, prophets "
                        ...
                        "the unjust know no shame. Despite YHWH cutting off nations as a warning, Jerusalem "
                        "was all the more eager to corrupt her deeds."
            },
            {
                ...
                "body": "YHWH will purify the nations, giving them 'pure speech' to serve him with one "
                        "accord -- the reversal of Babel's confusion. From beyond the rivers of Cush, "
                        "worshipers will bring offerings. The remnant of Israel will be humble and lowly, "
                        "taking refuge in YHWH's name. No more pride, no more arrogance on YHWH's holy "
                        "mountain. They will pasture and lie down with none to make them afraid."
            },
            {
                ...
                "body": "The most tender restoration passage in the prophets. Israel is called to sing, "
                        "shout, rejoice -- because YHWH has taken away their judgments and turned away "
                        "their enemies. The King of Israel, YHWH, is in their midst. The mighty warrior "
                        "who saves now rejoices with gladness, quiets with love, exults with singing. He "
                        "will gather the outcasts, deal with oppressors, save the lame, and change their "
                        "shame into praise among all the peoples of the earth."
            }
        ]
    }
]
