...
GLOSSARY = {
    ...
    # ── CANON, CHURCH HISTORY, THEOLOGY (20) ────────────────────

    "canon": {
        "hebrew": "κανών",
        "transliteration": "kanōn",
        "strongs": "G2583",
        "gloss": "rule, standard; authoritative list of Scripture",
        "term": "Canon",
        "definition": "From Greek kanon (measuring rod/standard). The authoritative list of books recognized as Scripture. The process of recognizing canonical books was gradual, spanning centuries — not a single decree. The Hebrew Bible was largely settled by the 2nd century BC (Torah, Prophets, Writings). The NT canon was debated through the 4th century, with Athanasius's 367 AD Festal Letter being the first to list the exact 27 NT books. Different Christian traditions (Protestant, Catholic, Orthodox, Ethiopian) recognize different OT canons.",
        "language": "greek",
        "category": "canon",
        "related_terms": ["deuterocanon", "apocrypha", "septuagint"],
        "key_refs": ["2 Timothy 3:16", "2 Peter 3:15-16"],
        "chapters_used": ["canon-torah-foundation", "canon-apostolic-authority", "canon-protestant-66"]
    },
    "deuterocanon": {
        "hebrew": "δευτεροκανών",
        "transliteration": "deuterokanōn",
        "strongs": "",
        "gloss": "second canon; additional canonical books",
        "term": "Deuterocanon",
        "definition": "Literally 'second canon' — books included in Catholic and Orthodox canons but not the Protestant Bible. Includes Tobit, Judith, Wisdom of Solomon, Sirach (Ecclesiasticus), Baruch, Letter of Jeremiah, 1-2 Maccabees, and additions to Daniel and Esther. These books were part of the Septuagint (Greek OT) used by the early church, but were not in the Hebrew Bible. Jerome distinguished them in his Vulgate translation, and the Council of Trent (1546) formally defined the Catholic 73-book canon including these works.",
        "language": "greek",
        "category": "canon",
        "related_terms": ["canon", "apocrypha", "council_of_trent", "septuagint"],
        "key_refs": ["2 Maccabees 12:46", "Wisdom 2:12-20"],
        "chapters_used": ["canon-catholic-73", "canon-disputed-books"]
    },
    "apocrypha": {
        "hebrew": "ἀπόκρυφος",
        "transliteration": "apokryphos",
        "strongs": "G614",
        "gloss": "hidden, concealed; non-canonical religious writings",
        "term": "Apocrypha",
        "definition": "From Greek apokryphos (hidden/concealed). Writings of disputed or secondary canonical status. Protestant usage: the Deuterocanonical books (Tobit, Wisdom, Sirach, Baruch, 1-2 Maccabees, etc.). Broader usage: any non-canonical religious writing, including the Gospel of Thomas, the Acts of Peter, and other texts excluded from all major canons. The term originally implied esoteric, hidden knowledge; over time it came to mean 'of doubtful authenticity.' Luther placed these books between the OT and NT as useful but not canonical.",
        "language": "greek",
        "category": "canon",
        "related_terms": ["deuterocanon", "canon"],
        "key_refs": ["Colossians 2:3"],
        "chapters_used": ["canon-disputed-books", "canon-gnostic-gospels"]
    },
    "nicene_creed": {
        "hebrew": "Σύμβολον Νικαίας",
        "transliteration": "Symbolon Nikaias",
        "strongs": "",
        "gloss": "statement of faith from the Council of Nicaea",
        "term": "Nicene Creed",
        "definition": "Statement of faith produced by the Council of Nicaea (325 AD), later expanded at Constantinople (381 AD). Affirms the Trinity and Christ's full deity against the Arian heresy, which taught that the Son was a created being. Key phrase: 'begotten, not made, of one substance (homoousios) with the Father.' The creed became the foundational confession of orthodox Christianity across Catholic, Orthodox, and most Protestant traditions. The later Western addition of the Filioque clause ('and the Son') became a major cause of the Great Schism.",
        "language": "greek",
        "category": "church_history",
        "related_terms": ["filioque", "great_schism"],
        "key_refs": ["John 1:1-3", "Colossians 1:15-17", "Hebrews 1:3"],
        "chapters_used": ["church-nicaea-council", "church-chalcedon-ephesus"]
    },
    "papal_infallibility": {
        "hebrew": "",
        "transliteration": "ex cathedra",
        "strongs": "",
        "gloss": "doctrine that the Pope cannot err when speaking officially on faith/morals",
        "term": "Papal Infallibility",
        "definition": "Catholic doctrine formally defined at Vatican I (1870) that when the Pope speaks ex cathedra ('from the chair') — that is, in his official capacity as supreme pastor on matters of faith and morals — he is preserved from error by divine assistance. This does not mean everything a pope says is infallible; it applies only to solemn, definitive pronouncements intended to bind the whole Church. It has been formally invoked only once since its definition: the 1950 dogma of the Assumption of Mary. Critics note that popes have contradicted each other historically and that this doctrine has no basis in the earliest centuries of Christianity.",
        "language": "latin",
        "category": "theology",
        "related_terms": ["magisterium", "apostolic_succession"],
        "key_refs": ["Matthew 16:18", "Luke 22:32", "1 Timothy 3:15"],
        "chapters_used": ["church-papal-infallibility", "church-bishop-pope"]
    },
    "transubstantiation": {
        "hebrew": "",
        "transliteration": "transsubstantiatio",
        "strongs": "",
        "gloss": "bread and wine become Christ's body and blood",
        "term": "Transubstantiation",
        "definition": "Catholic doctrine that during the Eucharist, the bread and wine literally become the body and blood of Christ while retaining the outward appearances (accidents) of bread and wine. Formally defined at the Fourth Lateran Council (1215) using Aristotelian categories of substance and accidents. Reaffirmed at the Council of Trent (1551) against Protestant challenges. Based on a literal reading of Jesus' words 'This is my body' (Matthew 26:26). Protestants variously hold to consubstantiation (Luther — Christ present 'in, with, and under' the elements), spiritual presence (Calvin), or memorial view (Zwingli).",
        "language": "latin",
        "category": "theology",
        "related_terms": ["council_of_trent"],
        "key_refs": ["Matthew 26:26-28", "1 Corinthians 11:23-26", "John 6:53-56"],
        "chapters_used": ["church-counter-reformation", "church-medieval-papacy"]
    },
    "purgatory": {
        "hebrew": "",
        "transliteration": "purgatorium",
        "strongs": "",
        "gloss": "state of purification after death",
        "term": "Purgatory",
        "definition": "Catholic belief in a state of purification after death for souls destined for heaven but not yet fully cleansed of the effects of sin. Souls in purgatory undergo temporal punishment before entering God's presence. The primary scriptural basis is 2 Maccabees 12:46 (prayers for the dead 'that they might be delivered from their sin') and inferences from 1 Corinthians 3:15 ('saved, but only as through fire'). The doctrine was systematized by medieval scholastic theologians and formally affirmed at the Councils of Florence (1439) and Trent (1563). Protestants reject purgatory as unbiblical, citing Hebrews 9:27 and the sufficiency of Christ's atonement.",
        "language": "latin",
        "category": "theology",
        "related_terms": ["indulgence", "council_of_trent"],
        "key_refs": ["2 Maccabees 12:46", "1 Corinthians 3:15", "Hebrews 9:27"],
        "chapters_used": ["church-medieval-papacy", "church-counter-reformation"]
    },
    "magisterium": {
        "hebrew": "",
        "transliteration": "magisterium",
        "strongs": "",
        "gloss": "the official teaching authority of the Catholic Church",
        "term": "Magisterium",
        "definition": "The official teaching authority of the Roman Catholic Church, exercised by the Pope and bishops in communion with him. Catholics hold the Magisterium as the authentic interpreter of both Scripture and Sacred Tradition. It operates at two levels: the Ordinary Magisterium (everyday teaching by bishops) and the Extraordinary Magisterium (solemn definitions by ecumenical councils or ex cathedra papal pronouncements). The Magisterium claims authority from Christ's commission to the apostles (Matthew 28:18-20) and the promise of the Spirit's guidance (John 16:13). Protestants reject this claim, holding that Scripture interprets Scripture (sola Scriptura).",
        "language": "latin",
        "category": "theology",
        "related_terms": ["papal_infallibility", "apostolic_succession", "sola_scriptura"],
        "key_refs": ["Matthew 28:18-20", "John 16:13", "1 Timothy 3:15"],
        "chapters_used": ["church-bishop-pope", "church-papal-infallibility"]
    },
    "apostolic_succession": {
        "hebrew": "",
        "transliteration": "successio apostolica",
        "strongs": "",
        "gloss": "unbroken chain of authority from the apostles through bishops",
        "term": "Apostolic Succession",
        "definition": "Doctrine held by Catholic and Orthodox churches that spiritual authority passes from the original apostles through an unbroken chain of ordained bishops via the laying on of hands. Central to Catholic and Orthodox ecclesiology — without valid apostolic succession, sacraments are considered invalid. Claimed basis: Paul's charge to Timothy (2 Timothy 2:2) and the appointment of elders (Titus 1:5). Protestant critique: the NT evidence shows 'elders' (presbyteroi) and 'bishops' (episkopoi) were the same office (Acts 20:17, 28; Titus 1:5-7), and the monarchical episcopate developed later, not from the apostles directly.",
        "language": "latin",
        "category": "church_history",
        "related_terms": ["magisterium", "papal_infallibility"],
        "key_refs": ["Acts 20:17", "Acts 20:28", "2 Timothy 2:2", "Titus 1:5-7"],
        "chapters_used": ["church-bishop-pope", "church-fathers-innovators"]
    },
    "sola_scriptura": {
        "hebrew": "",
        "transliteration": "sola Scriptura",
        "strongs": "",
        "gloss": "Scripture alone as the final rule of faith",
        "term": "Sola Scriptura",
        "definition": "Latin: 'Scripture alone.' The Protestant principle that the Bible is the sole infallible rule of faith and practice. This does not mean Scripture is the ONLY authority (Protestants value creeds, confessions, and church tradition) but that it is the FINAL and SUPREME authority to which all other authorities must submit. Central to the Reformation — Luther at the Diet of Worms (1521): 'Unless I am convinced by Scripture and plain reason... my conscience is captive to the Word of God.' Catholic critique: the Bible doesn't teach sola Scriptura, and the canon itself was determined by the Church. Protestant response: Scripture is self-authenticating, and the Church recognized (not created) the canon.",
        "language": "latin",
        "category": "theology",
        "related_terms": ["sola_fide", "magisterium", "canon"],
        "key_refs": ["2 Timothy 3:16-17", "Acts 17:11", "Isaiah 8:20"],
        "chapters_used": ["church-luther-95-theses", "church-counter-reformation"]
    },
    "sola_fide": {
        "hebrew": "",
        "transliteration": "sola fide",
        "strongs": "",
        "gloss": "justification by faith alone",
        "term": "Sola Fide",
        "definition": "Latin: 'by faith alone.' The central Reformation doctrine that justification before God is received through faith, not earned by human merit or works. Luther's key insight from Romans 1:17 and 3:28: 'For we hold that one is justified by faith apart from works of the law.' This was the material cause of the Reformation — Luther called it 'the article upon which the church stands or falls.' The Council of Trent (1547) formally anathematized sola fide. The debate often centers on James 2:24 ('a person is justified by works and not by faith alone'), which Protestants interpret as referring to the evidence of faith, not the ground of justification.",
        "language": "latin",
        "category": "theology",
        "related_terms": ["sola_scriptura", "indulgence", "council_of_trent"],
        "key_refs": ["Romans 1:17", "Romans 3:28", "Ephesians 2:8-9", "James 2:24"],
        "chapters_used": ["church-luther-95-theses", "church-counter-reformation"]
    },
    "filioque": {
        "hebrew": "",
        "transliteration": "Filioque",
        "strongs": "",
        "gloss": "'and the Son' — addition to the Nicene Creed",
        "term": "Filioque",
        "definition": "Latin: 'and the Son.' A clause added to the Nicene Creed by the Western (Latin) church, changing the phrase about the Holy Spirit from 'who proceeds from the Father' to 'who proceeds from the Father and the Son.' First appeared in the Third Council of Toledo (589 AD) and gradually spread through the Western church. The Eastern (Greek) church rejected this addition as both theologically wrong (it subordinates the Spirit and confuses the Father's unique role as source/origin) and canonically illegal (the Creed was altered without an ecumenical council). This controversy was a major contributing factor to the Great Schism of 1054.",
        "language": "latin",
        "category": "church_history",
        "related_terms": ["nicene_creed", "great_schism"],
        "key_refs": ["John 15:26", "John 14:26", "Galatians 4:6"],
        "chapters_used": ["church-great-schism", "church-nicaea-council"]
    },
    "indulgence": {
        "hebrew": "",
        "transliteration": "indulgentia",
        "strongs": "",
        "gloss": "remission of temporal punishment for sin",
        "term": "Indulgence",
        "definition": "In Catholic practice, the remission of temporal punishment due for sins that have already been forgiven. Based on the doctrine of the 'treasury of merit' — a spiritual reserve of the merits of Christ, Mary, and the saints that the Church can dispense. Originally, indulgences replaced harsh physical penances. By the late Middle Ages, they were sold for money to finance building projects (notably St. Peter's Basilica). Johann Tetzel's aggressive selling of indulgences provoked Luther's 95 Theses (1517) and sparked the Reformation.",
        "language": "latin",
        "category": "church_history",
        "related_terms": ["purgatory", "sola_fide", "council_of_trent"],
        "key_refs": ["Romans 3:24-25", "Ephesians 2:8-9", "1 John 2:2"],
        "chapters_used": ["church-medieval-papacy", "church-luther-95-theses"]
    },
    "theotokos": {
        "hebrew": "Θεοτόκος",
        "transliteration": "Theotokos",
        "strongs": "",
        "gloss": "God-bearer; Mother of God (title for Mary)",
        "term": "Theotokos",
        "definition": "Greek: 'God-bearer' or 'Mother of God.' Title for Mary affirmed at the Council of Ephesus (431 AD) against Nestorius, who preferred Christotokos ('Christ-bearer'). Originally a Christological statement — it affirmed that the one born of Mary was truly God incarnate, not merely a man in whom God dwelt. The council insisted: to deny Mary bore God is to deny the full divinity of the incarnate Christ. However, this title later became the foundation for extensive Marian devotion, including Mary as mediatrix, perpetual virgin, and co-redemptrix in Catholic theology. Protestants accept the Christological point but resist the Marian elevation built upon it.",
        "language": "greek",
        "category": "theology",
        "related_terms": ["nicene_creed"],
        "key_refs": ["Luke 1:43", "Galatians 4:4", "John 2:1-5"],
        "chapters_used": ["church-chalcedon-ephesus", "church-fathers-innovators"]
    },
    "dispensationalism": {
        "hebrew": "",
        "transliteration": "dispensationalism",
        "strongs": "",
        "gloss": "theology dividing history into distinct eras of God's dealings",
        "term": "Dispensationalism",
        "definition": "Theological system originated by John Nelson Darby (~1830s) that divides history into distinct eras (dispensations) in which God deals with humanity under different arrangements. Typically identifies seven dispensations: Innocence, Conscience, Human Government, Promise, Law, Grace, and the Millennial Kingdom. Key features: a sharp distinction between Israel and the Church, a pre-tribulation rapture, a literal future seven-year tribulation, and a literal thousand-year reign of Christ on earth. Popularized by the Scofield Reference Bible (1909). It is the primary theological foundation for much of modern Christian Zionism.",
        "language": "english",
        "category": "theology",
        "related_terms": ["christian_zionism", "zionism"],
        "key_refs": ["Daniel 9:24-27", "1 Thessalonians 4:17", "Revelation 20:1-6"],
        "chapters_used": ["zion-christian-zionism", "zion-daniel-70-weeks"]
    },
    "zionism": {
        "hebrew": "צִיּוֹנוּת",
        "transliteration": "Tsiyyonut",
        "strongs": "",
        "gloss": "movement for a Jewish national homeland",
        "term": "Zionism",
        "definition": "Movement advocating for the establishment and support of a Jewish national homeland in the land of Israel. Types: Political Zionism (Theodor Herzl, 1896 — secular nationalism), Cultural Zionism (Ahad Ha'am — Jewish cultural renewal), Religious Zionism (Rabbi Abraham Isaac Kook — divine redemption through return to the land). Many Orthodox Jews initially opposed Zionism, believing only the Messiah could legitimately restore Israel. The movement led to the Balfour Declaration (1917), the British Mandate, and the founding of the State of Israel (1948). The theological question remains: does modern Israel fulfill biblical prophecy, or is this a political event distinct from prophetic restoration?",
        "language": "hebrew",
        "category": "theology",
        "related_terms": ["christian_zionism", "dispensationalism", "replacement_theology"],
        "key_refs": ["Isaiah 11:11-12", "Ezekiel 37:21-22", "Amos 9:14-15"],
        "chapters_used": ["zion-birth-herzl", "zion-balfour-1948", "zion-holy-mountain"]
    },
    "replacement_theology": {
        "hebrew": "",
        "transliteration": "supersessionism",
        "strongs": "",
        "gloss": "the view that the Church has replaced Israel in God's plan",
        "term": "Replacement Theology",
        "definition": "Also called supersessionism. The theological view that the Church has permanently replaced ethnic Israel in God's plan, inheriting all of Israel's promises while Israel bears only the curses. Developed early in church history (Justin Martyr, Origen, Augustine). Three forms: punitive (God rejected Israel for rejecting Christ), economic (Israel's role was temporary), and structural (the Church is the 'new Israel'). Critiqued strongly by Paul in Romans 9-11, especially 11:1 ('Has God rejected his people? By no means!') and the olive tree metaphor (Romans 11:17-24) showing Gentile believers grafted into Israel's tree, not replacing it.",
        "language": "english",
        "category": "theology",
        "related_terms": ["christian_zionism", "zionism"],
        "key_refs": ["Romans 11:1", "Romans 11:17-24", "Romans 11:26-29"],
        "chapters_used": ["zion-replacement-olive-tree", "zion-christian-zionism"]
    },
    "christian_zionism": {
        "hebrew": "",
        "transliteration": "Christian Zionism",
        "strongs": "",
        "gloss": "belief that modern Israel fulfills biblical prophecy",
        "term": "Christian Zionism",
        "definition": "The belief that the modern State of Israel is a fulfillment of biblical prophecy and that Christians have a moral and theological obligation to support the Jewish state. Rooted primarily in dispensationalist theology (Darby, Scofield). Key proof texts: Genesis 12:3 ('I will bless those who bless you'), Isaiah 11:11-12 (a 'second' gathering), Ezekiel 37 (valley of dry bones). Critics argue it: (1) conflates political Israel with biblical Israel, (2) reads modern events into ancient prophecy, (3) Paul reads Abraham's 'offspring' as Christ (Galatians 3:16), not the modern state.",
        "language": "english",
        "category": "theology",
        "related_terms": ["zionism", "dispensationalism", "replacement_theology"],
        "key_refs": ["Genesis 12:3", "Galatians 3:16", "Galatians 3:29", "Romans 9:6-8"],
        "chapters_used": ["zion-christian-zionism", "zion-balfour-1948"]
    },
    "council_of_trent": {
        "hebrew": "",
        "transliteration": "Concilium Tridentinum",
        "strongs": "",
        "gloss": "Catholic council responding to the Reformation (1545-1563)",
        "term": "Council of Trent",
        "definition": "The 19th ecumenical council of the Catholic Church, held in Trent (northern Italy) in three sessions from 1545 to 1563. Convened in response to the Protestant Reformation. Key decisions: (1) Affirmed Sacred Tradition alongside Scripture as equal sources of divine revelation, explicitly rejecting sola Scriptura. (2) Defined the 73-book canon including the Deuterocanonical books. (3) Reaffirmed transubstantiation. (4) Anathematized sola fide — 'If anyone says that the sinner is justified by faith alone... let him be anathema' (Session VI, Canon IX). (5) Reformed clerical abuses. Trent shaped Catholic identity for 400 years until Vatican II (1962-65).",
        "language": "latin",
        "category": "church_history",
        "related_terms": ["sola_scriptura", "sola_fide", "deuterocanon", "transubstantiation"],
        "key_refs": ["James 2:24", "2 Thessalonians 2:15"],
        "chapters_used": ["church-counter-reformation", "canon-catholic-73"]
    },
    "great_schism": {
        "hebrew": "",
        "transliteration": "Schisma Magnum",
        "strongs": "",
        "gloss": "the 1054 split between Roman Catholic and Eastern Orthodox churches",
        "term": "Great Schism",
        "definition": "The formal split in 1054 between the Roman Catholic Church (West) and the Eastern Orthodox Church (East). Caused by centuries of accumulated theological, political, and cultural differences: (1) The Filioque controversy — the West's unauthorized addition to the Nicene Creed. (2) Papal supremacy — Rome claimed universal jurisdiction; the East held to a communion of co-equal patriarchs. (3) Liturgical differences — leavened vs. unleavened bread, clerical celibacy. The mutual excommunications of Cardinal Humbert and Patriarch Michael Cerularius in 1054 formalized the break. The Fourth Crusade's sack of Constantinople (1204) deepened the wound. The excommunications were lifted in 1965, but reunion remains elusive.",
        "language": "latin",
        "category": "church_history",
        "related_terms": ["filioque", "nicene_creed", "apostolic_succession"],
        "key_refs": ["John 17:21", "1 Corinthians 1:10-13", "Ephesians 4:3-6"],
        "chapters_used": ["church-great-schism", "church-bishop-pope"]
    },
    "septuagint": {
        "hebrew": "Ο΄",
        "transliteration": "Septuaginta (LXX)",
        "strongs": "",
        "gloss": "Greek translation of the Hebrew Scriptures",
        "term": "Septuagint",
        "definition": "The Greek translation of the Hebrew Scriptures, produced in Alexandria, Egypt during the 3rd-2nd centuries BC. According to the Letter of Aristeas, seventy-two Jewish scholars translated the Torah into Greek (hence the name 'Septuagint' — from Latin septuaginta, 'seventy,' abbreviated LXX). The LXX became the Bible of Greek-speaking Jews and was extensively quoted by New Testament authors. Crucially, the LXX preserves readings that differ from the later Masoretic Text, often matching the Dead Sea Scrolls. Key examples: Deuteronomy 32:8 reads 'sons of God' (LXX/DSS) instead of 'sons of Israel' (MT); Isaiah 7:14 uses parthenos ('virgin') where Hebrew has almah ('young woman'). The LXX also included the Deuterocanonical books.",
        "language": "greek",
        "category": "canon",
        "related_terms": ["canon", "deuterocanon", "apocrypha"],
        "key_refs": ["Deuteronomy 32:8", "Isaiah 7:14", "Hebrews 10:5-7"],
        "chapters_used": ["canon-septuagint-greek", "canon-dss-qumran", "canon-catholic-73"]
    },

    # ══════════════════════════════════════════════════════════════
    #  NAME THEOLOGY — Theophoric Names, Name Changes, Prophetic Names
    # ══════════════════════════════════════════════════════════════

    "theophoric_names": {
        "hebrew": "שֵׁם תֵּאוֹפוֹרִי",
        "transliteration": "theophoric name",
        "strongs": "",
        "gloss": "a personal name containing a divine element",
        "term": "Theophoric Name",
        "definition": "A name that embeds a divine name or title within it. In Hebrew Scripture, theophoric elements include: El (אֵל, 'God') as in Dani-El ('God is my judge'), Ezeki-El ('God strengthens'), Isra-El ('strives with God'); Yah/Yahu (יָהּ, short for YHWH) as in Eli-Yahu ('my God is YHWH'), Yesha-Yahu ('YHWH saves'), Yermi-Yahu ('YHWH exalts'); and Adon (אָדוֹן, 'Lord') as in Adoni-Yah ('my Lord is YHWH'). These names functioned as theological confessions — parents declared faith through their children's names. God Himself renames people to mark covenant identity shifts: Abram→Abraham, Sarai→Sarah, Jacob→Israel. In the NT, Jesus renames Simon to Peter (Cephas, 'Rock') and Saul takes the name Paul for his gentile mission.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["shem", "el_title", "yhwh"],
        "key_refs": ["Genesis 17:5", "Genesis 32:28", "Matthew 16:18", "Isaiah 7:14"],
        "chapters_used": ["gen-5", "gen-6", "gen-7", "gen-8"]
    },
    "name_isaiah": {
        "hebrew": "יְשַׁעְיָהוּ",
        "transliteration": "Yĕšaʿyāhû",
        "strongs": "H3470",
        "gloss": "YHWH saves; YHWH is salvation",
        "term": "Isaiah",
        "definition": "The prophet's name is itself a sermon: Yesha (salvation) + Yahu (YHWH) = 'YHWH saves.' His entire message — judgment leading to restoration — is encoded in his name. Isaiah named his own sons as prophetic signs: Shear-jashub (שְׁאָר יָשׁוּב, 'A Remnant Shall Return,' Isaiah 7:3) and Maher-shalal-hash-baz (מַהֵר שָׁלָל חָשׁ בַּז, 'Swift is the Spoil, Speedy is the Plunder,' Isaiah 8:3). The prophet's household became a living oracle — his wife is called 'the prophetess' (Isaiah 8:3). The name Yeshua (Jesus) shares the same root yesha (ישע, salvation), making Isaiah's name a direct etymological link to the Messiah.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["yeshua", "theophoric_names", "shear_jashub"],
        "key_refs": ["Isaiah 1:1", "Isaiah 7:3", "Isaiah 8:3", "Isaiah 9:6"],
        "chapters_used": ["isa-1", "isa-2", "isa-3"]
    },
    "name_jeremiah": {
        "hebrew": "יִרְמְיָהוּ",
        "transliteration": "Yirmĕyāhû",
        "strongs": "H3414",
        "gloss": "YHWH exalts; YHWH loosens/hurls",
        "term": "Jeremiah",
        "definition": "From rāmāh (רָמָה, to throw/exalt) + Yahu (YHWH). The name carries a dual meaning: 'YHWH exalts' (raises up a prophet) and 'YHWH hurls' (hurls judgment). Both meanings describe his ministry — God raised him up before birth (Jeremiah 1:5) to hurl the message of Jerusalem's destruction. The irony: the one whose name means 'YHWH exalts' is the most rejected, persecuted, and humiliated prophet. He was thrown into a cistern (Jeremiah 38:6), imprisoned, and forced to watch Jerusalem burn. Yet YHWH also 'loosens' — Jeremiah prophesies the New Covenant (Jeremiah 31:31-34), the greatest message of release in the OT.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "new_covenant"],
        "key_refs": ["Jeremiah 1:5", "Jeremiah 31:31-34", "Jeremiah 38:6"],
        "chapters_used": ["jer-1", "jer-2"]
    },
    "name_ezekiel": {
        "hebrew": "יְחֶזְקֵאל",
        "transliteration": "Yĕḥezqēʾl",
        "strongs": "H3168",
        "gloss": "God strengthens; God makes strong",
        "term": "Ezekiel",
        "definition": "From ḥāzaq (חָזַק, to be strong) + El (God) = 'God strengthens.' A priest-prophet exiled to Babylon, Ezekiel needed divine strength for an almost impossible ministry: telling exiles that their beloved temple would be destroyed while also promising a future temple of stunning glory (Ezekiel 40-48). God literally told him to be silent except when given words (Ezekiel 3:26-27), to lie on his side for 430 days (Ezekiel 4:4-6), and to not mourn when his wife died (Ezekiel 24:16-18). Only God's strengthening power could sustain such a calling.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "divine_council"],
        "key_refs": ["Ezekiel 1:1-3", "Ezekiel 3:8-9", "Ezekiel 37:1-14"],
        "chapters_used": ["ezek-1", "ezek-2"]
    },
    "name_daniel": {
        "hebrew": "דָּנִיֵּאל",
        "transliteration": "Dāniyyēʾl",
        "strongs": "H1840",
        "gloss": "God is my judge",
        "term": "Daniel",
        "definition": "From dîn (דִּין, to judge) + El (God) = 'God is my judge.' Daniel lived under pagan rulers who claimed divine authority — Nebuchadnezzar, Belshazzar, Darius, Cyrus — yet his very name declared that only God judges rightly. When Babylon renamed him Belteshazzar (protecting the king's life), Daniel kept his Hebrew name as an act of theological resistance. The book's theme of divine judgment over empires (the statue of Daniel 2, the beasts of Daniel 7, the handwriting on the wall in Daniel 5) perfectly matches the prophet's name. Ezekiel 14:14 lists Daniel alongside Noah and Job as paragons of righteousness — his name-identity remained uncorrupted despite 70 years in Babylon.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names"],
        "key_refs": ["Daniel 1:6-7", "Daniel 2:44", "Daniel 7:13-14", "Ezekiel 14:14"],
        "chapters_used": ["dan-1", "dan-2"]
    },
    "name_hosea": {
        "hebrew": "הוֹשֵׁעַ",
        "transliteration": "Hôšēaʿ",
        "strongs": "H1954",
        "gloss": "salvation; he saves",
        "term": "Hosea",
        "definition": "From yāšaʿ (יָשַׁע, to save/deliver). The same root as Joshua (Yehoshua, 'YHWH saves') and Jesus (Yeshua). The prophet named 'Salvation' was commanded to marry Gomer (possibly 'completion' — she would complete the judgment message) and name their three children as living prophecies: Jezreel ('God scatters,' Hosea 1:4), Lo-Ruhamah ('Not pitied/No mercy,' Hosea 1:6), and Lo-Ammi ('Not my people,' Hosea 1:9). These three names trace covenant dissolution. Yet Hosea 2:1 reverses it: 'Say to your brothers Ammi (My people) and to your sisters Ruhamah (Shown mercy).' The prophet whose name means 'Salvation' embodies the full arc: judgment through un-naming, then salvation through re-naming.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "yeshua", "name_isaiah"],
        "key_refs": ["Hosea 1:2-9", "Hosea 2:1", "Hosea 2:23"],
        "chapters_used": ["hos-1", "hos-2"]
    },
    "name_micah": {
        "hebrew": "מִיכָה",
        "transliteration": "Mîḵāh",
        "strongs": "H4318",
        "gloss": "Who is like YHWH?",
        "term": "Micah",
        "definition": "Short form of Mikayahu (מִיכָיָהוּ): Mî (who) + kā (like) + Yahu (YHWH) = 'Who is like YHWH?' This rhetorical question is the prophet's entire theology in three words. Micah himself answers his own name in Micah 7:18: 'Who is a God like you, pardoning iniquity?' (mî-ʾēl kāmôḵā). The rural prophet from Moresheth challenged both Samaria and Jerusalem with the incomparable holiness of YHWH. His most famous prophecy — Bethlehem as the Messiah's birthplace (Micah 5:2) — answers his name's question: the incomparable God will become incarnate in the humblest of towns.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names"],
        "key_refs": ["Micah 1:1", "Micah 5:2", "Micah 6:8", "Micah 7:18"],
        "chapters_used": ["mic-1"]
    },
    "name_zechariah": {
        "hebrew": "זְכַרְיָה",
        "transliteration": "Zĕḵaryāh",
        "strongs": "H2148",
        "gloss": "YHWH remembers",
        "term": "Zechariah",
        "definition": "From zāḵar (זָכַר, to remember) + Yah (YHWH) = 'YHWH remembers.' Post-exilic prophet who received visions of Jerusalem's restoration at the precise moment when Israel wondered if God had forgotten them. His name is his message: YHWH has NOT forgotten His covenant, His city, or His people. Contains the most messianic prophecies of any minor prophet: the Branch (3:8, 6:12), the pierced one (12:10), the shepherd struck down (13:7), and the King entering on a donkey (9:9). In the NT, Zechariah the priest (father of John the Baptist) bears the same name — and his son's birth proves YHWH remembered His promise (Luke 1:72).",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "branch_messiah"],
        "key_refs": ["Zechariah 1:1", "Zechariah 9:9", "Zechariah 12:10", "Luke 1:72"],
        "chapters_used": ["zech-1", "zech-2"]
    },
    "name_malachi": {
        "hebrew": "מַלְאָכִי",
        ...
        "gloss": "my messenger",
        "term": "Malachi",
        "definition": "From malʾāḵ (מַלְאָךְ, messenger/angel) + î (my) = 'My messenger.' Some scholars debate whether this is a personal name or a title — Malachi 3:1 uses the same word: 'Behold, I send my messenger (malʾāḵî) to prepare the way before me.' The last OT prophet's name thus blurs the line between his own identity and the coming forerunner (John the Baptist). The same root malʾāḵ can mean 'angel' or 'messenger,' connecting Malachi to the divine council's messenger beings. His name prophetically points forward 400 years to the one who would break the silence.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "malak"],
        "key_refs": ["Malachi 1:1", "Malachi 3:1", "Malachi 4:5-6", "Matthew 11:10"],
        "chapters_used": ["mal-1"]
    },
    "name_nahum": {
        "hebrew": "נַחוּם",
        "transliteration": "Naḥûm",
        "strongs": "H5151",
        "gloss": "comfort; consolation",
        "term": "Nahum",
        "definition": "From nāḥam (נָחַם, to comfort/console). The prophet named 'Comfort' delivers one of the harshest oracles in Scripture — total annihilation of Nineveh. The irony is intentional: Nahum's comfort is directed at Judah, not Assyria. The oppressor's destruction IS the oppressed people's consolation. This is the same root used in Isaiah 40:1: 'Comfort, comfort my people' (naḥamû naḥamû ʿammî). Also the root behind Nehemiah (Nechemyah, 'YHWH comforts') and the name Menachem.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names"],
        "key_refs": ["Nahum 1:1", "Nahum 1:7", "Nahum 3:7"],
        "chapters_used": ["nah-1"]
    },
    "name_obadiah": {
        "hebrew": "עֹבַדְיָה",
        "transliteration": "ʿŌḇaḏyāh",
        "strongs": "H5662",
        "gloss": "servant of YHWH",
        "term": "Obadiah",
        "definition": "From ʿeḇeḏ (עֶבֶד, servant) + Yah (YHWH) = 'Servant of YHWH.' One of the most common theophoric names in the OT (13 different Obadiahs). The prophet named 'Servant of YHWH' delivers judgment against Edom for betraying their brother nation Judah. The name's theological weight: true servanthood to YHWH sometimes means pronouncing hard truths against those who harm God's people. The Edomites served themselves; Obadiah served YHWH.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "ebed_yhwh"],
        "key_refs": ["Obadiah 1:1", "Obadiah 1:10-12"],
        "chapters_used": ["obad-1"]
    },
    "name_peter": {
        "hebrew": "Πέτρος / כֵּיפָא",
        "transliteration": "Petros / Kēphaʾ",
        "strongs": "G4074",
        "gloss": "rock; stone",
        "term": "Peter (Cephas)",
        "definition": "Simon (Shimʿôn, שִׁמְעוֹן, 'he has heard') was renamed by Jesus to Cephas (Aramaic kēphaʾ, 'rock') or Peter (Greek petros, 'stone'). Matthew 16:18: 'You are Peter (Petros), and on this rock (petra) I will build my church.' This is the most theologically significant NT name change — paralleling God's renaming of Abram→Abraham and Jacob→Israel. The fisherman who 'heard' (Simon) becomes the 'foundation' (Peter). Yet Peter's rocklike calling is tested by denial (Luke 22:54-62) and restored by Jesus' threefold recommissioning (John 21:15-17). The man of hearing must become the man of unshakable foundation.",
        "language": "greek",
        "category": "name_theology",
        "related_terms": ["theophoric_names"],
        "key_refs": ["Matthew 16:18", "John 1:42", "Luke 22:54-62", "John 21:15-17"],
        "chapters_used": ["matt-3", "matt-4"]
    },
    "name_paul": {
        "hebrew": "Παῦλος / שָׁאוּל",
        "transliteration": "Paulos / Šāʾûl",
        "strongs": "G3972 / H7586",
        "gloss": "small (Latin); asked for (Hebrew)",
        "term": "Paul (Saul)",
        "definition": "Born Saul (Šāʾûl, שָׁאוּל, 'asked for' — the same name as Israel's first king), renamed/reidentified as Paul (Paulos, from Latin paulus, 'small/humble'). Unlike Peter's renaming by Jesus, Paul's name shift occurs naturally at Acts 13:9 — the moment he confronts a Jewish sorcerer and begins his Gentile mission. The Pharisaic zealot named after Israel's tallest king becomes the humble apostle to the nations. He likely always had both names (Jewish + Roman), but Luke's literary shift marks an identity transformation: from Saul the persecutor to Paul the preacher. Paul himself embraces smallness: 'I am the least of the apostles' (1 Corinthians 15:9).",
        "language": "greek",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "name_peter"],
        "key_refs": ["Acts 13:9", "Acts 9:1-15", "1 Corinthians 15:9", "Galatians 1:13-16"],
        "chapters_used": ["acts-1", "acts-2"]
    },
    "name_joshua_yeshua": {
        "hebrew": "יְהוֹשֻׁעַ / יֵשׁוּעַ",
        "transliteration": "Yĕhôšûaʿ / Yēšûaʿ",
        "strongs": "H3091 / H3442",
        "gloss": "YHWH saves; YHWH is salvation",
        "term": "Joshua / Jesus",
        "definition": "Joshua (Yehoshua, יְהוֹשֻׁעַ) = YHWH (Yeho-) + saves (-shua). Originally named Hoshea ('salvation'), Moses added the divine name: 'Moses called Hoshea son of Nun, Joshua' (Numbers 13:16). This is the SAME name as Jesus: the post-exilic shortened form Yeshua (יֵשׁוּעַ) was Hellenized to Iēsous (Ἰησοῦς) in Greek, then Latinized to 'Jesus.' Joshua led Israel into the Promised Land; Jesus leads humanity into the Kingdom of God. The name connection is not coincidence — it is typological fulfillment. Hebrews 4:8 makes the link explicit, and Matthew 1:21 explains: 'You shall call his name Jesus, for he will save his people from their sins.'",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["yeshua", "theophoric_names", "name_isaiah", "name_hosea"],
        "key_refs": ["Numbers 13:16", "Matthew 1:21", "Hebrews 4:8", "Acts 7:45"],
        "chapters_used": ["josh-1", "matt-1"]
    },
    "name_eve": {
        "hebrew": "חַוָּה",
        "transliteration": "Ḥawwāh",
        "strongs": "H2332",
        "gloss": "life-giver; living one",
        "term": "Eve",
        "definition": "From ḥāyāh (חָיָה, to live). Genesis 3:20: 'The man called his wife's name Eve (Ḥawwāh), because she was the mother of all living (ḥāy).' The naming occurs immediately AFTER the fall and curse — an act of radical faith. Adam has just heard the curse of death, yet he names his wife 'Life.' This is the first instance of naming-as-prophecy: despite the curse, life will continue. Moreover, Genesis 3:15 has just promised that the woman's seed will crush the serpent — Adam's naming of Eve as 'Life-giver' may be his response of faith to the protoevangelium.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "protoevangelium"],
        "key_refs": ["Genesis 2:23", "Genesis 3:15", "Genesis 3:20"],
        "chapters_used": ["gen-2", "gen-3"]
    },
    "name_ruth": {
        "hebrew": "רוּת",
        "transliteration": "Rûṯ",
        "strongs": "H7327",
        "gloss": "friend; companion; satiated",
        "term": "Ruth",
        "definition": "Possibly from rēʿûṯ (רֵעוּת, friendship/companionship) or rāwāh (רָוָה, to saturate/drink deeply). As a Moabitess who clung to Naomi and Israel's God, Ruth embodies friendship across ethnic boundaries. Her declaration 'Your people shall be my people, and your God my God' (Ruth 1:16) is the most powerful conversion statement in the OT. Ruth entered the lineage of David and ultimately of Jesus (Matthew 1:5) — a Moabite outsider whose friendship and faith placed her in the ancestry of the Messiah.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["hesed", "name_naomi"],
        "key_refs": ["Ruth 1:16-17", "Ruth 4:13-17", "Matthew 1:5"],
        "chapters_used": ["ruth-1", "ruth-2"]
    },
    "name_naomi": {
        "hebrew": "נָעֳמִי / מָרָא",
        "transliteration": "Noʿŏmî / Mārāʾ",
        "strongs": "H5281 / H4755",
        "gloss": "pleasantness → bitterness",
        "term": "Naomi / Mara",
        "definition": "Naomi (from nāʿēm, נָעֵם, 'pleasant, delightful') renames herself Mara (from mārar, מָרַר, 'bitter'): 'Do not call me Naomi; call me Mara, for the Almighty has dealt very bitterly with me' (Ruth 1:20). This is the only case in Scripture where someone renames THEMSELVES to express suffering. She left Bethlehem ('House of Bread') full and returned empty. Yet the book's arc reverses the name: through Ruth's loyalty and Boaz's redemption, Naomi's bitterness becomes joy (Ruth 4:14-17). The women of Bethlehem say: 'A son has been born to Naomi' — she is Pleasant again.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["name_ruth", "goel"],
        "key_refs": ["Ruth 1:20-21", "Ruth 4:14-17"],
        "chapters_used": ["ruth-1"]
    },
    "name_hannah": {
        "hebrew": "חַנָּה",
        "transliteration": "Ḥannāh",
        "strongs": "H2584",
        "gloss": "grace; favor",
        "term": "Hannah",
        "definition": "From ḥēn (חֵן, grace/favor). The woman named 'Grace' was barren — seemingly without God's favor. Yet her prayer at Shiloh (1 Samuel 1:10-11) produced Samuel, and her song (1 Samuel 2:1-10) became the theological template for Mary's Magnificat (Luke 1:46-55). Hannah's name prophecy: grace comes not through human ability but through divine gift. She named her son Samuel (Shĕmûʾēl), wordplaying on shāʾal (שָׁאַל, 'to ask'): 'I asked him of YHWH' (1 Samuel 1:20). The one named Grace gives her son — the one 'asked of God' — back to God. Grace gives, and gives again.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["hen", "name_samuel"],
        "key_refs": ["1 Samuel 1:20", "1 Samuel 2:1-10", "Luke 1:46-55"],
        "chapters_used": ["1sam-1"]
    },
    "name_samuel": {
        "hebrew": "שְׁמוּאֵל",
        "transliteration": "Šĕmûʾēl",
        "strongs": "H8050",
        "gloss": "heard of God; name of God",
        "term": "Samuel",
        "definition": "Compound of shēm (שֵׁם, name) + El (God) = 'Name of God' or 'Heard of God.' Hannah's explanation wordplays on shāʾal (to ask): 'Because I asked him of YHWH' (1 Samuel 1:20). This creates a deliberate etymological triangle: Samuel's name means 'Name of God,' but his origin story emphasizes 'asked of God' — which is actually the meaning of Saul (Šāʾûl). Samuel and Saul are thus linguistically intertwined from birth. The prophet who bears God's Name will anoint — and un-anoint — the king who was 'asked for.' Name theology drives the entire narrative of 1 Samuel.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names", "name_hannah", "shem"],
        "key_refs": ["1 Samuel 1:20", "1 Samuel 3:1-10", "1 Samuel 8:4-7"],
        "chapters_used": ["1sam-1"]
    },
    "name_esther": {
        "hebrew": "אֶסְתֵּר / הֲדַסָּה",
        "transliteration": "ʾEstēr / Hăḏassāh",
        "strongs": "H635",
        "gloss": "star (Persian); myrtle (Hebrew)",
        "term": "Esther (Hadassah)",
        "definition": "Esther has TWO names, reflecting her dual identity. Her Hebrew name Hadassah (from hăḏas, הֲדַס, 'myrtle tree') connects her to Israel. Her Persian name Esther likely derives from the Persian stāra ('star') or the Babylonian goddess Ishtar. The entire book of Esther famously never mentions God's name — yet the protagonist's hidden Jewish identity mirrors God's hidden providence. She conceals her Hebrew name just as God conceals His name from the text. When she reveals her true identity to save her people (Esther 7:3-4), it parallels the theological revelation that God has been working behind the scenes all along. The hidden name IS the theology.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["theophoric_names"],
        "key_refs": ["Esther 2:7", "Esther 4:14", "Esther 7:3-4"],
        "chapters_used": ["esth-1"]
    },
    "name_bethlehem": {
        "hebrew": "בֵּית לֶחֶם",
        "transliteration": "Bêṯ Leḥem",
        "strongs": "H1035",
        "gloss": "House of Bread",
        "term": "Bethlehem",
        "definition": "From bayiṯ (בַּיִת, house) + leḥem (לֶחֶם, bread) = 'House of Bread.' The name gains layered significance throughout Scripture: Ruth gleans grain in Bethlehem's fields (Ruth 2), David is anointed there (1 Samuel 16), Micah prophesies the Messiah's origin there (Micah 5:2), and Jesus — who calls Himself 'the Bread of Life' (John 6:35) — is born in the House of Bread. Rachel was buried nearby (Genesis 35:19), and the name appears in the Naomi narrative of famine: she left the 'House of Bread' when there was no bread (Ruth 1:1). The place name is itself a messianic sign.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["name_ruth", "name_naomi"],
        "key_refs": ["Ruth 1:1", "1 Samuel 16:1", "Micah 5:2", "Matthew 2:1", "John 6:35"],
        "chapters_used": ["ruth-1", "1sam-2", "mic-1", "matt-1"]
    },
    "name_jerusalem": {
        "hebrew": "יְרוּשָׁלַיִם",
        "transliteration": "Yĕrûšālayim",
        "strongs": "H3389",
        "gloss": "foundation of peace; city of peace",
        "term": "Jerusalem",
        "definition": "Most likely from yārāh (יָרָה, to establish/found) + šālôm (שָׁלוֹם, peace) = 'Foundation of Peace.' Some derive it from an earlier Canaanite form Uru-Salim ('City of [the god] Shalem'). Its earliest biblical name is Salem (שָׁלֵם, Genesis 14:18), where Melchizedek — priest of God Most High — ruled. The dual ending -ayim may suggest the 'two Jerusalems': earthly and heavenly (Galatians 4:26, Revelation 21:2). The city whose name means 'Peace' has been conquered, destroyed, and fought over more than any other city on earth — making the eschatological promise of true shalom all the more powerful.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["shalom", "melchizedek"],
        "key_refs": ["Genesis 14:18", "Psalm 122:6", "Galatians 4:26", "Revelation 21:2"],
        "chapters_used": ["gen-5", "psa-1"]
    },
    "shear_jashub": {
        "hebrew": "שְׁאָר יָשׁוּב",
        "transliteration": "Šĕʾār Yāšûḇ",
        "strongs": "",
        "gloss": "a remnant shall return",
        "term": "Shear-jashub",
        "definition": "Isaiah's firstborn son, whose name is a walking prophecy: 'A Remnant Shall Return.' Isaiah brought this child to meet King Ahaz during the Syro-Ephraimite crisis (Isaiah 7:3), making the boy's very presence a divine message: Assyria would devastate, but a remnant would survive and return. The name combines shĕʾār (שְׁאָר, remnant) + yāšûḇ (יָשׁוּב, shall return). This remnant theology becomes central to Isaiah's message (Isaiah 10:21-22, 11:11, 28:5) and is picked up by Paul in Romans 9:27 and 11:5. Isaiah's son embodied hope in his very identity.",
        "language": "hebrew",
        "category": "name_theology",
        "related_terms": ["name_isaiah", "remnant"],
        "key_refs": ["Isaiah 7:3", "Isaiah 10:21-22", "Romans 9:27"],
        "chapters_used": ["isa-1", "isa-2"]
    }
}
