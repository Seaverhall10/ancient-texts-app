"""
era_75.py -- Weeping Over Zion (Lamentations 1-5)

Five acrostic poems mourning the destruction of Jerusalem in 586 BC. This is
the Hebrew Bible's grief made poetry -- unflinching in its depiction of horror,
theologically courageous in attributing the destruction to YHWH's sovereign
judgment, and stubbornly hopeful in its central affirmation that "the steadfast
love (chesed) of YHWH never ceases" (3:22). The book moves from Daughter
...
affliction (ch 3), back to communal horror (ch 4), and finally to a raw,
unresolved prayer (ch 5). The acrostic structure -- each poem using the 22
letters of the Hebrew alphabet -- imposes literary order on existential chaos:
the poet says everything that can be said, from aleph to tav, and the alphabet
holds even when the world does not.
"""
...
CHAPTERS = [
...

    {
        ...
        "sections": [
            {
                "heading": "Gold Grows Dim -- Reversal of Glory (4:1-6)",
            ...
            {
                "heading": "Famine's Horror -- Compassionate Women Boil Their Children (4:7-11)",
            ...
            {
                "heading": "Blame and Futile Hope (4:12-20)",
            ...
            {
                "heading": "Edom's Cup Is Coming (4:21-22)",
...

    {
        ...
        "sections": [
            {
                "heading": "Remember, O YHWH -- The Opening Plea (5:1-10)",
            ...
            {
                "heading": "The Social Order Shattered (5:11-18)",
            ...
            {
                "heading": "But You, O YHWH -- The Eternal Throne and the Unresolved Plea (5:19-22)",
