"""
era_66.py -- Under the Sun: The Whole of Ecclesiastes (1-12)

Ecclesiastes is a unified philosophical-theological meditation that defies
neat division into eras. The argument spirals: Qoheleth raises a theme,
probes it, qualifies it, and returns to it later with deeper insight. The
chapters here are grouped into manageable study units that follow the book's
internal logic: the thesis and royal experiment (1-2), the times poem and
divine sovereignty (3-4), wisdom for worship and wealth (5-6), the limits
of wisdom (7-8), death and enjoyment (9-10), and the conclusion (11-12).
"""
