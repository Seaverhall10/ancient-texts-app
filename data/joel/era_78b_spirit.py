"""
era_78b_spirit.py -- Joel 2:28-3:21: The Spirit Poured Out -- Pentecost and Final Judgment

The climactic conclusion of Joel: YHWH pours out his Spirit on all flesh --
sons and daughters, old and young, male and female servants. Prophetic access is
democratized. Cosmic signs herald the Day of YHWH, and 'everyone who calls on
the name of YHWH shall be saved.' Then the nations are gathered to the Valley of
Jehoshaphat for judgment. Peter cites this text at Pentecost; Paul cites it in
Romans; John draws on it in Revelation. The book ends with Edenic restoration
and YHWH dwelling in Zion.
"""
...
CHAPTERS = [
    {
        ...
        "synopsis": "After the locust judgment and restoration of Joel 2:1-27, the prophet pivots to the "
                    ...
                    "on all flesh; your sons and your daughters shall prophesy, your old men shall dream "
                    "dreams, and your young men shall see visions. Even on the male and female servants in "
                    "those days I will pour out my Spirit' (2:28-29). This is the democratization of the "
                    "prophetic gift. In the Old Testament, the Spirit empowered specific individuals -- "
                    "prophets, kings, judges. Joel promises universal access. Before the great and awesome "
                    "Day of YHWH, cosmic signs appear: 'blood and fire and columns of smoke. The sun shall be "
                    "turned to darkness, and the moon to blood' (2:30-31). Yet the passage culminates in "
                    "grace: 'And it shall come to pass that everyone who calls on the name of YHWH shall be "
                    "saved. For in Mount Zion and in Jerusalem there shall be those who escape, as YHWH has "
                    "said, and among the survivors shall be those whom YHWH calls' (2:32). Peter identifies "
                    "Pentecost as the fulfillment of this promise (Acts 2:16-21). Paul universalizes the "
                    "salvation offer in Romans 10:13.",
        ...
        "original_terms": [
            ...
            "chalomot (dreams -- old men dream dreams; a mode of divine revelation, cf. Num 12:6)",
            "chezyonot (visions -- young men see visions; prophetic sight given to the next generation)",
            "qara beshem YHWH (to call on the name of YHWH -- the salvation condition; quoted by Paul in Rom 10:13)"
        ],

        "ane_backdrop": "In the ancient Near East, the spirit of a deity was understood as the divine power "
                        "that enabled humans to act beyond their natural capacity. In Israel, YHWH's Spirit "
                        "empowered judges to deliver (Judg 3:10; 6:34), kings to rule (1 Sam 16:13), and "
                        "prophets to speak (Ezek 2:2). The radical nature of Joel's promise is that this "
                        "Spirit would be given to 'all flesh' -- without regard to age, gender, or social "
                        "status. In a culture where prophecy was the province of a recognized prophetic class, "
                        "this was revolutionary. Moses had wished for it (Num 11:29); Joel declares it will "
                        "happen.",
        ...
        "second_temple": [
            ...
            },
            {
                ...
                "summary": "Paul: 'There is neither Jew nor Greek, there is neither slave nor free, there is "
                           "no male and female, for you are all one in Christ Jesus.'",
                "relevance": "Joel's Spirit promise already anticipated the breaking of social boundaries -- "
                             "sons and daughters, old and young, male and female servants. Paul's baptismal "
                             "formula echoes this leveling effect of the Spirit."
            }
        ],

        "cross_refs": [
            {"ref": "Numbers 11:29", "note": "Moses: 'Would that all YHWH's people were prophets!' -- Joel 2:28 fulfills this wish", "type": "ot"},
            {"ref": "Isaiah 32:15", "note": "'Until the Spirit is poured upon us from on high' -- the same eschatological Spirit outpouring", "type": "ot"},
            {"ref": "Ezekiel 36:26-27", "note": "'I will put my Spirit within you' -- the new covenant promise of inward transformation", "type": "ot"},
            {"ref": "Acts 2:16-21", "note": "Peter quotes Joel 2:28-32 at Pentecost -- the Spirit on all flesh fulfilled", "type": "nt"},
            {"ref": "Romans 10:13", "note": "Paul quotes Joel 2:32 -- universal salvation for all who call on the name of the Lord", "type": "nt"},
            {"ref": "Revelation 6:12", "note": "Sixth seal: sun darkened, moon to blood -- Joel's cosmic signs in the apocalyptic vision", "type": "nt"}
        ],
        ...
        "sections": [
            {
                "heading": "The Spirit on All Flesh (2:28-29)",
                "body": "The climactic promise: 'afterward' -- after the locust judgment and restoration -- "
                        ...
                        "male and female servants will all prophesy. Every social boundary is crossed: age, "
                        "gender, and class. Moses' wish (Num 11:29) becomes YHWH's eschatological decree."
            },
            {
                "heading": "Cosmic Signs Before the Day (2:30-31)",
                "body": "Before the great and awesome Day of YHWH: blood, fire, columns of smoke. The sun "
                        "turns to darkness and the moon to blood. These cosmic disturbances signal the "
                        "approach of the divine warrior. The celestial order itself responds to YHWH's "
                        "coming -- the heavenly luminaries bow before their maker."
            },
            {
                "heading": "Everyone Who Calls Shall Be Saved (2:32)",
                "body": "The salvation condition is simple and universal: 'Everyone who calls on the name "
                        "of YHWH shall be saved.' Deliverance is in Mount Zion and Jerusalem -- the place "
                        "of YHWH's presence. Among the survivors are 'those whom YHWH calls' -- salvation "
                        "is both human response (calling) and divine initiative (calling). Peter and Paul "
                        "both cite this verse as the foundation of gospel proclamation."
            }
        ]
    },

    {
        ...
        "original_terms": [
            ...
            "gath (winepress -- 'the winepress is full'; blood imagery of final judgment)",
            "sha'ag (to roar -- 'YHWH roars from Zion'; the divine warrior's battle cry)",
        ...
        "ane_backdrop": "The Valley of Jehoshaphat may be the Kidron Valley between Jerusalem and the Mount "
                        ...
                        "Amos 1:6-10 and Ezekiel 27. The reversal of Isaiah's plowshares-to-swords vision "
                        "is a deliberate prophetic inversion: when the nations refuse peace, they are summoned "
                        "to the war they chose.",
        ...
        "second_temple": [
            ...
            },
            {
                ...
                "summary": "The river of the water of life flowing from the throne of God, with the tree of "
                           "life bearing fruit.",
                "relevance": "Joel 3:18's fountain flowing from the house of YHWH finds its ultimate "
                             "fulfillment in Revelation's vision of the renewed Eden in the New Jerusalem."
            }
        ],
        ...
        "cross_refs": [
            ...
            {"ref": "Amos 1:6-10", "note": "Amos indicts Gaza and Tyre for the same slave trade Joel condemns", "type": "ot"},
        ...
        "divine_council_note": "Joel 3 is an explicit divine council judgment scene. YHWH gathers the nations "
                               ...
                               "final verdict on the rebellious nations and their spiritual patrons. The Edenic "
                               "closing vision (mountains dripping wine, fountain from YHWH's house) signals "
                               "the restoration of the divine order: YHWH dwelling in Zion, his people secure, "
                               "creation flourishing under his direct rule.",
