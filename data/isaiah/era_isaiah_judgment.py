...
CHAPTERS = [
...

    {
        ...
        "cross_refs": [
            ...
            {"ref": "Psalm 89:5-7", "note": "'Your faithfulness in the assembly of the holy ones... A God greatly feared in the council of the holy ones' -- the same divine council worship scene Isaiah witnesses", "type": "ot"},
            {"ref": "Isaiah 52:13", "note": "'High and lifted up (ram venissa)' -- the same enthronement language applied to the Suffering Servant, linking the throne room of ch. 6 to the exalted Servant of ch. 53", "type": "ot"},
            {"ref": "Hebrews 12:18-24", "note": "The contrast between Sinai's terror and the 'heavenly Jerusalem... innumerable angels in festal gathering' -- believers now approach the throne room Isaiah entered", "type": "nt"},
            {"ref": "Matthew 13:14-15", "note": "Jesus quotes Isaiah 6:9-10 to explain why he speaks in parables -- the judicial hardening commission extends into the messianic age", "type": "nt"},
            {"ref": "2 Corinthians 3:14-16", "note": "'A veil lies over their hearts. But when one turns to the Lord, the veil is removed' -- the Isaiah 6:10 blindness reversed in Christ", "type": "nt"},
            {"ref": "Genesis 1:26", "note": "'Let US make man in our image' -- the same divine council plural as Isaiah 6:8's 'Whom shall I send, and who will go for US?'", "type": "ot"}
        ],
